...
file1 = open(r"C:\\Users\\noury\\Desktop\\python\\enregist.txt", "a")
...
pwd = input("password: ")
compare = log + "---" + pwd
file1 = open("C:\\Users\\noury\\Desktop\\python\\enregist.txt", "r")
for logins in file1:
    if compare == logins.strip():
        print("login est déja enregitré")
            ...
            if choice == 'A':
                ...
                while True:
                     ...
                     if choice == 'a':
                            ...
                            print("\nPublic Key:")
                            print(public_key)
                            file2=open("C:\\Users\\noury\\Desktop\\python\\keys.txt", "a")
                ...
                while True:
                  ...
                  if choice == 'a':
                        ...
                        print("\nPublic Key:")
                        print(public_key)
                        file3=open("C:\\Users\\noury\\Desktop\\python\\certificat.txt", "a")
